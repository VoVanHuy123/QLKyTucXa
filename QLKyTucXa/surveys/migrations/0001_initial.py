    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('question', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='question_responses', to='surveys.surveyquestion')),
            ...
            options={
                ...
                'constraints': [models.UniqueConstraint(fields=('question', 'student'), name='unique_question_student')],
            },
        ),
    ]
